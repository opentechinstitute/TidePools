    ...
    if ($class == 'record') {
        ...
        switch ($type) {
            ...
            case "etkinlik":
                ...
                echo 'Etkinligin Adi</br><input type="text" id="name"
                    name="name" maxlength="50" value=""/></br>';
                echo 'Neler oluyor?</br> <textarea name="description"
                ...
                echo '<input type="button" id="submit" value="Cancel"
                    onClick="window.location.reload()" />';
                echo '</br><hr>';
                echo '</br><b>Ne zaman? (landmark will appear/disappear
                ...
                echo '<input type="radio" name="timespec" value="weekly">
                    Weekly';
                echo '</br>Baslangic Tarih/Saat  <input type="text"
                    name="startdatetimepicker" id="startdatetimepicker"
                    value="Click Here" />';
                echo '</br>Bitis Tarih/Saat  <input type="text"
