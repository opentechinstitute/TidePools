...
<div id="searcher" style=
  "font-family:Tahoma, Geneva, sans-serif; padding: 1px; position:relative; top: 80px; left: 460px; display:inline-block; margin-bottom:6px; cursor:pointer; opacity: 1; z-index:2;" value='Hide Layer' onclick= "getLocation();" class="target"><button class="whereAmI"> Yerimi Goster</button> <img src="assets/images/gps.png" width="43" height="43" />
</div>
</div>
...
<div style="width:auto; height:5; background-color:#7f275b; position: relative;"></div>
    ...
    <img style="display: none;" src="assets/images/sms_note.png" "="" style=" z-index: 5;float: right; top: 102px; position: relative; height: 75px;width: 420px;">
